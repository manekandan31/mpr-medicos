...
# Monkey patch six for django compatibility with djongo
try:
    import six
...
SECRET_KEY = os.environ.get('DJANGO_SECRET_KEY', 'django-insecure-6_i73v%oa*p4zc@^#ajw(t)#^eu0oyu789feue1#kouhk+hne1')
